...
import PostsComment from "../components/PostsComment.vue"
        ...
        <el-container>
            ...
            <el-main>
                <div max-w="960px" w="96/100" mx="auto">
                    <PostsContent :PostId="postId" />
                    <ElDivider></ElDivider>
                    <PostsComment :PostId="postId" />
                </div>
            </el-main>
            <el-footer>
                <div text="sm center gray">评论区到底啦...</div>
            </el-footer>
        </el-container>
    </div>
</template>